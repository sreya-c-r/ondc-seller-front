                ...
                <form action="{{route('dashboard')}}" method="GET">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" required maxlength="4"
                                    class="w-full rounded-lg border-gray-300 border px-4 py-3 text-sm focus:outline-none placeholder-gray-400"
                                    placeholder="123">
                                <i class="fa-solid fa-circle-question absolute right-4 top-3.5 text-gray-300 cursor-help"
                    ...
                    <div class="flex items-start mb-8">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-600">
                            ...
                            authorize the monthly subscription charge.
                        </label>
                    </div>

                    <button type="submit"
                        class="w-full bg-blue-600 text-white font-bold text-lg py-4 px-8 rounded-xl shadow-md hover:bg-blue-700 hover:shadow-xl transition transform hover:-translate-y-0.5">
                        Pay & Subscribe
                    </button>
