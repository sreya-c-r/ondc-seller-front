    ...
    <div class="pt-24 pb-12 min-h-screen flex items-center justify-center p-4">
        <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 max-w-md w-full">
            ...
            <form action="{{ route('login.submit') }}" method="POST">
                ...
                <button
                    class="w-full mt-4 bg-white border border-gray-300 text-gray-700 font-bold py-3 px-4 rounded-lg hover:bg-gray-50 transition duration-200 flex justify-center items-center gap-2"
                    type="button">
